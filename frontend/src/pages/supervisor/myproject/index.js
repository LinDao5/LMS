...
const MyProject = (props) => {
    ...
    const getMyProject = async () => {
        ...
        await API.getMyProject(token)
            .then((response) => {
                console.log("myProjectData", response.data);
                const {res} = response.data;
                if (res === 1) {
                    const {myProject} = response.data;
                    console.log("myProjectSuccess:", myProject);
    ...
    return (
        <div>
            ...
            <Container style={{marginBottom: "40px"}}>
                ...
                <h3 className={classes.paper}>My Project</h3>
