    ...
    return (
        <div>
            ...
            <Container style={{marginBottom: "40px"}}>
                ...
                <h3 className={classes.paper}>Submission History</h3>
                    ...
                    <TableContainer className={classes.container}>
                        <Table stickyHeader aria-label="sticky table">
                            <TableBody>
                                ...
                                {
                                    latestSubmissions.slice(page*rowsPerPage, page*rowsPerPage+rowsPerPage).map((item, index) => {
                                        return (
                                          <SubmissionHistory data={item} />
                                        );
                                    })
                                }
                            </TableBody>
...
export default connect(mapStateToProps, mapDispatchToProps)(SupervisorGrading);